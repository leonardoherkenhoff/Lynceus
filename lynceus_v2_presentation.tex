...
\begin{frame}{Contribuição 1: Performance em Base Justa (Extração)}
    ...
    \begin{table}[]
        ...
        \midrule
        \textbf{Lynceus Base (495 Feat.)} & 33.547.574 & 276.926 & 14.632,60 & Sobreviveu (2.0M fluxos) \\
        \textbf{Lynceus NFX Parity (12 Feat.)} & 33.547.574 & \textbf{886.608} & \textit{Leve} & Sobreviveu (2.0M fluxos) \\
        NFX Original (User-space) & 1 file & 117.999 & 2,60 & \alert{Falhou no 1º PCAP} \\
        \textbf{Lynceus Rust Parity (159 Feat.)} & 33.547.574 & \textbf{884.661} & 14.140,50 & Sobreviveu (2.0M fluxos) \\
        RustiFlow Original & 2.012.712 flows & 34.113 & 3.435,60 & Sobreviveu (Fragmentou) \\
        \bottomrule
        \end{tabular}
        }
    \end{table}
