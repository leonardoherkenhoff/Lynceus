...
# --- Dual-Stack Categories (RustiFlow supports IPv6) ---
PCAP_CATEGORIES = ["PCAP", "PCAPv6"]
...
EXPERIMENTS = [
    ...
    },
    {
        ...
        "setup_cmd": (
            "make clean && make "
            "CFLAGS='-g -O2 -Wall -Wextra -std=gnu11 -DPARITY_RUSTIFLOW' "
...
def main():
    ...
    Iterates over the engine matrix (RustiFlow, then Lynceus parity).
    ...
    print(f"\n{'='*60}")
    print("[✔] RustiFlow Parity Assessment Concluded.")
