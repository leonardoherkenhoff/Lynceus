# Makefile - Lynceus v1.0
# Description: High-Performance eBPF Flow Extraction Engine
# -----------------------------------------------------------------------------
# Objective: High-fidelity network feature extraction and real-time telemetry.
# This Makefile orchestrates the compilation of the Lynceus pipeline, 
# supporting high-throughput monitoring for professional infrastructures.
#
# Requirements:
...
CFLAGS = -g -O3 -march=native -flto -funroll-loops -Wall -Wextra -std=gnu11
